package com.example.pyonsu.kidsdrawingapp
...
class MainActivity : AppCompatActivity() {
            ...
            if(requestCode== GALLERY){
                try{
                    if(data!!.data != null){
                        ...
                        Toast.makeText(
                            this,
                            "Error in parsing the image or image or its corrupted.",
                            Toast.LENGTH_SHORT
                        ).show()
                    }
                }catch (e:Exception){
    ...
    private fun requestStoragePermission(){
        if (ActivityCompat.shouldShowRequestPermissionRationale(
            ...
            Toast.makeText(this, "Needpermission to add a Background", Toast.LENGTH_SHORT).show()
        }
